...
bool FCEUI_Initialize() {
	...
	FSettings.VRC6Volume = 256;       //0-256 scale (256 is max volume)
	FSettings.VRC7Volume = 256;       //0-256 scale (256 is max volume)
	FSettings.FDSVolume = 256;        //0-256 scale (256 is max volume)
	FSettings.MMC5Volume = 256;       //0-256 scale (256 is max volume)
	FSettings.N163Volume = 256;       //0-256 scale (256 is max volume)
	FSettings.S5BVolume = 256;        //0-256 scale (256 is max volume)
