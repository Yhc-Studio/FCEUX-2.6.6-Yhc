...
static BMAPPING bmap[] = {
	...
	{ "42in1ResetSwitch", Mapper233_Init, 0 },
	{ "43272", UNL43272_Init, 0 },
	{ "603-5052", UNL6035052_Init, 0 },
	{ "64in1NoRepeat", BMC64in1nr_Init, 0 },
	{ "70in1", Mapper236_Init, 0 },
	{ "70in1B", Mapper236_Init, 0 },
	...
	{ "Ghostbusters63in1", BMCGhostbusters63in1_Init, 0 },//test
	...
	{ "KS106C", BMCKS106C_Init, 0 }, /* split roms */
	{ "900218", BTL900218_Init, 0 },
	{ "JC-016-2", Mapper205_Init, 0 },
	{ "AX-40G", UNLAX40G_Init, 0 },
	{ "STREETFIGTER-GAME4IN1", BMCSFGAME4IN1_Init, 0 }, /* mapper 49? submapper 1*/
	...
	{ "FARID_UNROM_8-IN-1", FRAID_UNROM_Init, 0 },
	{ "K-3033", BMCK3033_Init, 0 },
	{ "830134C", BMC830134C_Init, 0 },
	{ "GN-26", BMCGN26_Init, 0 },
	{ "KG256", KG256_Init, 0 },
	{ "T4A54A", Mapper134_Init, 0 },
	{ "WX-KB4K", Mapper134_Init,0 },
	{ "SB-5013", Mapper359_Init,  0 },
	{ "82112C", Mapper540_Init, 0 },
	{ "N49C-300", Mapper369_Init,0 },
	{ "830752C", Mapper396_Init, 0 },
	{ "22026", Mapper271_Init, 0 },
	{ "Yhc-Axrom-Cart", Mapper500_Init, 0 },
	{ "Yhc-Unrom-Cart", Mapper501_Init, 0 },
	{ "Yhc-A/B/Uxrom-Cart", Mapper502_Init, 0 },
	{ "Yhc-Nrom/Cnrom-Cart", Nrom_Cnrom_Cart_Init, 0 },
	{ "S-2009", Mapper434_Init, 0 },
	{ "WELL-NO-DG450", Mapper428_Init, 0 },
	{ "AB-G1L", Mapper428_Init, 0 },
	{ "TF2740", Mapper428_Init, 0 },
	{ "971107-00G", BMC_971107_00G_Init, 0 },
	{ "RESET-TXROM", BMCRESETTXROM_Init, 0 },
	{ "L6IN1", BMCL6IN1_Init, 0 },
	{ "WS", BMCWS_Init, 0 },
	{ "GN-26", BMCGN26_Init, 0 },
	{ "M2C52A", Mapper380_Init, 0 },
	{ "TL-8042", Mapper453_Init, 0 },
	{ "DG574B", Mapper445_Init, 0 },
	{ "GOLDEN-16IN1-SPC001", Golden_Spc001_Init, 0 },
	{ "DS-07", Mapper439_Init, 0 },
	{ "BS-400R",  Mapper422_Init, 0 },
	{ "BS-4040R",  Mapper422_Init, 0 },
	{ "22026", Mapper271_Init,  0 },
	{ "831128C", Mapper528_Init, 0 },
	{ "CHINA_ER_SAN2", Mapper19_Init, 0 },
	{ "Yhc-Unrom-Cart",     Mapper500_Init,        0 },
	{ "Yhc-Axrom-Cart",     Mapper501_Init,        0 },
	{ "Yhc-A/B/Uxrom-Cart", Mapper502_Init,        0 },
	{ "JY4M4",              Mapper537_Init,        0 },
	{ "82112C",             Mapper540_Init,        0 },
	{ "KN-20",              Mapper577_Init,        0 },
	{ "820436-C",           Mapper579_Init,        0 },
	{ "8203",               Mapper585_Init,        0 },
	{ "K-3057",             Mapper587_Init,        0 },
	{ "K-3010",             Mapper438_Init,        0 },
	{ "JY88S",              Mapper411_Init,        0 },
	{ "K86B",               Mapper439_Init,        0 },
	{ 0, 0, 0 }
};
